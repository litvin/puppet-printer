...
1. [Setup - The basics of getting started with printer](#setup)
    * [What printer affects](#what-printer-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with printer](#beginning-with-printer)
